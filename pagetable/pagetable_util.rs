...
impl PageTable{
    ...
    pub fn resolve_mapping_4K_l3(&self, l4i:L4Index, l3i:L3Index) -> (ret: (Option<PageEntry>, PageTableErrorCode))
        requires    
            ...
            0 <= l3i < 512,
        ensures
            ret.0 =~= self.spec_resolve_mapping_4K_l3(l4i, l3i),
            ...
            ret.1 == PageTableErrorCode::L3EntryNotExist <==> self.spec_resolve_mapping_1G_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_2M_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_4K_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_l4(l4i).is_Some(),
    ...
    pub fn resolve_mapping_4K_l2(&self, l4i:L4Index, l3i:L3Index, l2i:L2Index) -> (ret: (Option<PageEntry>, PageTableErrorCode))
        requires    
            ...
            0 <= l2i < 512,
        ensures
            ret.0 =~= self.spec_resolve_mapping_4K_l2(l4i, l3i, l2i),
            ret.0.is_Some() <==> ret.1 == PageTableErrorCode::NoError,
            ret.1 == PageTableErrorCode::L4EntryNotExist <==> self.spec_resolve_mapping_l4(l4i).is_None(),
            ret.1 == PageTableErrorCode::L3EntryNotExist <==> self.spec_resolve_mapping_1G_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_2M_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_4K_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_l4(l4i).is_Some(),
            ret.1 == PageTableErrorCode::L2EntryNotExist <==> self.spec_resolve_mapping_2M_l2(l4i, l3i, l2i).is_None() && self.spec_resolve_mapping_4K_l2(l4i, l3i, l2i).is_None() && self.spec_resolve_mapping_4K_l3(l4i, l3i).is_Some(),
            ret.1 == PageTableErrorCode::EntryTakenBy1G <==> self.spec_resolve_mapping_1G_l3(l4i, l3i).is_Some(),
    ...
    pub fn resolve_mapping_4K_l1(&self, l4i:L4Index, l3i:L3Index, l2i:L2Index, l1i:L2Index) -> (ret: (Option<PageEntry>, PageTableErrorCode, Option<MapEntry>))
        ...
        ensures
            ...
            ret.1 == PageTableErrorCode::L3EntryNotExist ==> self.spec_resolve_mapping_1G_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_2M_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_4K_l3(l4i, l3i).is_None() && self.spec_resolve_mapping_l4(l4i).is_Some(),
            ret.1 == PageTableErrorCode::L2EntryNotExist ==> self.spec_resolve_mapping_2M_l2(l4i, l3i, l2i).is_None() && self.spec_resolve_mapping_4K_l2(l4i, l3i, l2i).is_None() && self.spec_resolve_mapping_4K_l3(l4i, l3i).is_Some(),
            ret.1 == PageTableErrorCode::L1EntryNotExist ==> self.spec_resolve_mapping_4K_l1(l4i, l3i, l2i, l1i).is_None() && self.spec_resolve_mapping_4K_l2(l4i, l3i, l2i).is_Some(),
            ret.1 == PageTableErrorCode::EntryTakenBy1G <==> self.spec_resolve_mapping_1G_l3(l4i, l3i).is_Some(),
            ret.1 == PageTableErrorCode::EntryTakenBy2M <==> self.spec_resolve_mapping_2M_l2(l4i, l3i, l2i).is_Some(),
